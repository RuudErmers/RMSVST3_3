...
uses UCodeSiteLogger,SysUtils,UCEditController,UVST3Utils,UVST3Processor,UVST3Controller;
...
begin
  ...
  begin
    ...
    fPlugin:=TVST3Processor.Create;
    fPlugin.OnCreate(fPluginInfo,true);
    instance:=fPlugin;
    instance._addRef;
    found:=true;
  end;
// here we have to add the creation of the controller
  ...
  begin
    ...
    fPlugin:=TVST3Controller.Create;
    fPlugin.OnCreate(fPluginInfo,false);
    instance:=fPlugin;
    instance._addRef;
    found:=true;
  end;
