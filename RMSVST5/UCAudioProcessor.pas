    ...
    begin
      ...
      begin
        ...
        case event.eventType of
          kNoteOnEvent       : with event.noteOn do IVST3.MidiEvent(true,channel+MIDI_NOTE_ON,pitch,round(127*velocity));
          kNoteOffEvent      :  with event.noteOff do IVST3.MidiEvent(true,channel+MIDI_NOTE_OFF,pitch,round(127*velocity));
